...
/* Bento layout — on md+ this tiles a 4-col grid exactly:
   ...
   (cartooningillo3 & 4 to be re-added once provided.) */
const gallery = [
...
const skills = [
  {
    title: "Drawing and colored pencil techniques",
  },
  {
    title: "Monthly themed projects",
  },
  {
    title: "Animation field studies",
  },
  {
    title: "Character development and mood boarding",
  },
  {
...
const logistics = [
  ...
  { label: "Session ", value: "Thursdays: 3:20 - 5:20 PM" },
      ...
      <main className="flex-1">
        ...
        <section className="grain relative isolate">
          ...
          <div className="mx-auto max-w-7xl px-4 md:px-6 pt-20 pb-20">
            ...
            This class is designed for students who love animation and are looking to learn both digital and analog techniques.            </p>
            <p className="mt-8 max-w-2xl text-lg text-ink leading-relaxed">
          ...
          <div className="mx-auto max-w-7xl px-4 md:px-6 py-24">
            <div className="grid gap-12 md:grid-cols-[1fr_2fr]">
              <div>
                ...
                Best suited for students who love art and want a fun, yet structured, introduction to more serious artistic learning.
                </p>
              </div>
